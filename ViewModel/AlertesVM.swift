...
class AlertClass: ObservableObject {
    @Published var signalements: [Signalement] = [
        Signalement(type: .grooming, nom: "Patapon2021", description: "Bonjour depuis quelques jours je reçois des messages d'une personne que je ne connais pas, en plus de ça elle a l'air beaucoup plus agée que moi. \r Je ne sais pas trop quoi faire.", read: false),
