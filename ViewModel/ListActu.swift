...
class ListArticlesActu: ObservableObject {
    ...
    @Published var listActu : [Article] = [
        ...
        Article(image: "triste", titre: "PROTÉGER SES ENFANTS DU CYBERHARCÈLEMENT: FAUT-IL LES ESPIONNER ?", content: "blablabla"),
        Article(image: "stop1", titre: "LES NOUVELLES MESURES ANTI-CYBERHARCÈLEMENT", content: "oui oui"),
        Article(image: "dark", titre: "PAS OUF LE CYBERHARCÈLEMENT FAUT VRAIMENT CESSER ÇA", content: "non merci aled c tro")
    ]
