...
class ListArticlesEvents: ObservableObject {
    ...
    @Published var listEvents : [Article] = [
        ...
        Article(image: "united", titre: "COLLOQUE INTERNATIONAL CONTRE LE CYBERHARCÈLEMENT À NANCY", publication: "Publié le 30 juin 2023 à 19h30", content: "blablabla"),
        ...
        Article(image: "luttededos", titre: "CYBERHARCÈLEMENT DES FEMMES ET PERSONNES LGBTQIA+", publication: "Publié le 26 juin 2023 à 14h41", content: "non merci aled c tro")
    ]
